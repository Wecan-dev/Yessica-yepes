...
class VerticalSplitSliderContentItem implements Lib\ShortcodeInterface {
	...
	function __construct() {
		$this->base = 'edge_vertical_split_slider_content_item';
	...
	public function vcMap() {
		vc_map( array(
			'name' => esc_html__('Edge Slide Content Item', 'edge-core'),
			'base' => $this->base,
			'icon' => 'icon-wpb-vertical-split-slider-content-item extended-custom-icon',
			'category' => esc_html__('by EDGE', 'edge-core'),
			'as_parent' => array('except' => 'vc_row'),
			'as_child' => array('only' => 'edge_vertical_split_slider_left_panel, edge_vertical_split_slider_right_panel'),
	...
	public function render($atts, $content = null) {
		...
		$html = edge_core_get_shortcode_module_template_part('templates/vertical-split-slider-content-item-template', 'vertical-split-slider', '', $params);
