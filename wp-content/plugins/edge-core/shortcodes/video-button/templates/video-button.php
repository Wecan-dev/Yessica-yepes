...
<div class="edge-video-button-holder">
	...
	<?php if(!empty($play_button_image)) { ?>
		<a class="edge-video-button-play-image <?php echo esc_attr($link_class); ?>" href="<?php echo esc_url($video_link); ?>" target="_self" data-rel="prettyPhoto[video_button_pretty_photo_<?php echo esc_attr($rand); ?>]">
	...
	<?php } else { ?>
		<a class="edge-video-button-play" <?php echo adorn_edge_get_inline_style($play_button_styles); ?> href="<?php echo esc_url($video_link); ?>" target="_self" data-rel="prettyPhoto[video_button_pretty_photo_<?php echo esc_attr($rand); ?>]">
			<span class="edge-video-button-play-inner">
