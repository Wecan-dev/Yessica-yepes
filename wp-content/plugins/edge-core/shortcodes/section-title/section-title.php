...
class SectionTitle implements Lib\ShortcodeInterface {
	...
	* @return string
	...
	public function render($atts, $content = null) {
		...
		$html = edge_core_get_shortcode_module_template_part('templates/section-title', 'section-title', '', $params);
	...
	private function getTextStyles($params) {
		...
		if (!empty($params['text_line_height'])) {
			$styles[] = 'line-height: '.adorn_edge_filter_px($params['text_line_height']).'px';
		}
		...
		if (!empty($params['text_margin'])) {
			$styles[] = 'margin-top: '.adorn_edge_filter_px($params['text_margin']).'px';
		}
