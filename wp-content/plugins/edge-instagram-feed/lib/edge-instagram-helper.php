...
/**
 * Class EdgeInstagramHelper
 */
class EdgeInstagramHelper {
    /**
     * Generates HTML for given image from Instagram feed. Defines edge_instagram_image_atts filter
    ...
    public function getImageHTML($image, $imageSize) {
        ...
        $imageAtts = apply_filters('edge_instagram_image_atts',
            array(
                'class' => $imageSize,
