...
if (adorn_edge_is_woocommerce_installed()) {
	...
	include_once EDGE_FRAMEWORK_MODULES_ROOT_DIR.'/woocommerce/admin/taxonomies-map/taxonomies.php';
	include_once EDGE_FRAMEWORK_MODULES_ROOT_DIR.'/woocommerce/admin/taxonomies-map/field-creator.php';
