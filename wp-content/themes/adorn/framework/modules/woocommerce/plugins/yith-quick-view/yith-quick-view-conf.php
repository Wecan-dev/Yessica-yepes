...
add_action( 'yith_wcqv_product_summary', 'adorn_edge_woocommerce_yith_template_single_title', 5 );
...
add_action('yith_wcqv_product_image', 'adorn_edge_woocommerce_show_product_images', 9);

//Add yith quick view button
add_action( 'adorn_edge_woo_pl_info_below_image', 'adorn_edge_woocommerce_quickview_link', 2 );
...
add_action('yith_wcqv_product_summary', 'adorn_edge_woocommerce_share_wish_tag_before', 30);
add_action('yith_wcqv_product_summary', 'adorn_edge_woocommerce_share_wish_tag_after', 35);

add_action( 'yith_wcqv_product_summary', function() { echo do_shortcode( "[yith_wcwl_add_to_wishlist]" ); }, 31 );

//Add social share (default woocommerce_share)
add_action( 'yith_wcqv_product_summary', 'adorn_edge_woocommerce_share', 32 );
