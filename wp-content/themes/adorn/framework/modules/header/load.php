...
//options
include_once EDGE_FRAMEWORK_MODULES_ROOT_DIR.'/header/options-map/parts/top-bar-map.php';
include_once EDGE_FRAMEWORK_MODULES_ROOT_DIR.'/header/options-map/parts/logo-area-map.php';
include_once EDGE_FRAMEWORK_MODULES_ROOT_DIR.'/header/options-map/parts/menu-area-map.php';
include_once EDGE_FRAMEWORK_MODULES_ROOT_DIR.'/header/options-map/header-map.php';
include_once EDGE_FRAMEWORK_MODULES_ROOT_DIR.'/header/options-map/header-mobile-map.php';
include_once EDGE_FRAMEWORK_MODULES_ROOT_DIR.'/header/options-map/types/header-centered-map.php';

//header types
include_once EDGE_FRAMEWORK_MODULES_ROOT_DIR.'/header/types/header-centered.php';
include_once EDGE_FRAMEWORK_MODULES_ROOT_DIR.'/header/types/header-divided.php';
include_once EDGE_FRAMEWORK_MODULES_ROOT_DIR.'/header/types/header-minimal.php';
...
include_once EDGE_FRAMEWORK_MODULES_ROOT_DIR.'/header/types/header-top-menu.php';
include_once EDGE_FRAMEWORK_MODULES_ROOT_DIR.'/header/types/header-vertical.php';
include_once EDGE_FRAMEWORK_MODULES_ROOT_DIR.'/header/types/header-vertical-closed.php';
