...
class BlogSlider implements Lib\ShortcodeInterface {
    ...
    function __construct() {
        $this->base = 'edge_blog_slider';

        add_action('vc_before_init', array($this,'vcMap'));

        //Category filter
        add_filter( 'vc_autocomplete_edge_blog_slider_category_callback', array( &$this, 'blogListCategoryAutocompleteSuggester', ), 10, 1 ); // Get suggestion(find). Must return an array

        //Category render
        add_filter( 'vc_autocomplete_edge_blog_slider_category_render', array( &$this, 'blogListCategoryAutocompleteRender', ), 10, 1 ); // Get suggestion(find). Must return an array
    }
    ...
    public function vcMap() {
        vc_map( array(
            'name' => esc_html__('Edge Blog Slider', 'adorn'),
            'base' => $this->base,
    ...
    public function render($atts, $content = null) {
        ...
        adorn_edge_get_module_template_part('shortcodes/blog-slider/holder', 'blog', '', $params);
