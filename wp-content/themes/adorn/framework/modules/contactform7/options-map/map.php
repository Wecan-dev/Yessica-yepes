...
if ( ! function_exists('adorn_edge_contact_form_7_options_map') ) {

	function adorn_edge_contact_form_7_options_map() {

		adorn_edge_add_admin_page(array(
			'slug'	=> '_contact_form7_page',
			'title'	=> esc_html__('Contact Form 7', 'adorn'),
			'icon'	=> 'fa fa-envelope-o'
		));

		$panel_contact_form_style_1 = adorn_edge_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_1',
			'title'	=> esc_html__('Custom Style 1', 'adorn')
		));

		//Text Typography

		$typography_text_group = adorn_edge_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'adorn'),
			'description'	=> esc_html__('Setup typography for form elements text', 'adorn'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_text_row1 = adorn_edge_add_admin_row(array(
		...
		adorn_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Text Color', 'adorn'),
		));
		...
		$typography_text_row2 = adorn_edge_add_admin_row(array(
		...
		$typography_text_row3 = adorn_edge_add_admin_row(array(
		...
		$typography_label_group = adorn_edge_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'adorn'),
			'description'	=> esc_html__('Setup typography for form elements label', 'adorn'),
			'parent'		=> $panel_contact_form_style_1
		));

		$typography_label_row1 = adorn_edge_add_admin_row(array(
		...
		$typography_label_row2 = adorn_edge_add_admin_row(array(
		...
		$background_border_group = adorn_edge_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'adorn'),
			'description'	=> esc_html__('Setup form elements background and border style', 'adorn'),
			'parent'		=> $panel_contact_form_style_1
		));

		$background_border_row1 = adorn_edge_add_admin_row(array(
		...
		adorn_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Color', 'adorn')
		));
		...
		adorn_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Background Transparency', 'adorn')
		));

		$background_border_row2 = adorn_edge_add_admin_row(array(
		...
		adorn_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Transparency', 'adorn'),
		));
		...
		adorn_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Color', 'adorn')
		));
		...
		adorn_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Focus Border Transparency', 'adorn')
		));

		$background_border_row3 = adorn_edge_add_admin_row(array(
		...
		adorn_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Width', 'adorn'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		adorn_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Radius', 'adorn'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$padding_group = adorn_edge_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'adorn'),
			'description' => esc_html__( 'Setup form elements padding', 'adorn' ),
			'parent'		=> $panel_contact_form_style_1
		));

		$padding_row = adorn_edge_add_admin_row(array(
			'name'		=> 'padding_row',
		...
		adorn_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Top', 'adorn'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		adorn_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Right', 'adorn'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		adorn_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Bottom', 'adorn'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		adorn_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Padding Left', 'adorn'),
			'args'			=> array(
				'suffix' => 'px'
			)
		));
		...
		$margin_group = adorn_edge_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'adorn'),
			'description'	=> esc_html__('Setup form elements margin', 'adorn'),
			'parent'		=> $panel_contact_form_style_1
		));

		$margin_row = adorn_edge_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		adorn_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Textarea Height', 'adorn'),
			'description'	=> esc_html__('Enter height for textarea form element', 'adorn'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$button_typography_group = adorn_edge_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'adorn'),
			'description'	=> esc_html__('Setup button text typography', 'adorn'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_typography_row1 = adorn_edge_add_admin_row(array(
		...
		$button_typography_row2 = adorn_edge_add_admin_row(array(
		...
		$button_background_border_group = adorn_edge_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'adorn'),
			'description'	=> esc_html__('Setup button background and border style', 'adorn'),
			'parent'		=> $panel_contact_form_style_1
		));

		$button_background_border_row1 = adorn_edge_add_admin_row(array(
		...
		adorn_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Color', 'adorn')
		));
		...
		adorn_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Background Hover Transparency', 'adorn')
		));

		$button_background_border_row2 = adorn_edge_add_admin_row(array(
		...
		adorn_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Color', 'adorn')
		));
		...
		adorn_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Border Hover Transparency', 'adorn')
		));

		$button_background_border_row3 = adorn_edge_add_admin_row(array(
		...
		adorn_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Height', 'adorn'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		adorn_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Button Left/Right Padding', 'adorn'),
			'args'			=> array(
				'col_width' => '3',
				'suffix' => 'px'
			)
		...
		$panel_contact_form_style_2 = adorn_edge_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'adorn')
		));
        ...
        $panel_contact_form_style_3 = adorn_edge_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'adorn')
        ));
        ...
        $typography_label_row3 = adorn_edge_add_admin_row(array(
        ...
        $button_typography_row3 = adorn_edge_add_admin_row(array(
	...
	add_action( 'adorn_edge_options_map', 'adorn_edge_contact_form_7_options_map', 19);
}