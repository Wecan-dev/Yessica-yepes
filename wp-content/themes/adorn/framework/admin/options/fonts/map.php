...
if ( ! function_exists('adorn_edge_fonts_options_map') ) {
	/**
	 * Font options page
	 */
	function adorn_edge_fonts_options_map() {

		adorn_edge_add_admin_page(
			array(
				'slug' => '_fonts_page',
				'title' => esc_html__('Fonts', 'adorn'),
				'icon' => 'fa fa-font'
			)
		);
		 ...
		 * Headings
		 */
		$panel_headings = adorn_edge_add_admin_panel(
			array(
				'page' => '_fonts_page',
				'name' => 'panel_headings',
				'title' => esc_html__('Headings', 'adorn')
			)
		);

		//H1
		$group_heading_h1 = adorn_edge_add_admin_group(array(
			'name'			=> 'group_heading_h1',
			'title'			=> esc_html__('H1 Style', 'adorn'),
			'description'	=> esc_html__('Define styles for h1 heading', 'adorn'),
			'parent'		=> $panel_headings
		));

		$row_heading_h1_1 = adorn_edge_add_admin_row(array(
		...
		$row_heading_h1_2 = adorn_edge_add_admin_row(array(
        ...
        $row_heading_h1_3 = adorn_edge_add_admin_row(array(
        ...
        adorn_edge_add_admin_field(array(
            ...
            'name'			=> 'h1_margin_top',
            'default_value'	=> '',
            'label'			=> esc_html__('Margin Top', 'adorn'),
        ...
        adorn_edge_add_admin_field(array(
            ...
            'default_value'	=> '',
            'label'			=> esc_html__('Margin Bottom', 'adorn'),
            'parent'		=> $row_heading_h1_3
        ));

		//H2
		$group_heading_h2 = adorn_edge_add_admin_group(array(
			'name'			=> 'group_heading_h2',
			'title'			=> esc_html__('H2 Style', 'adorn'),
			'description'	=> esc_html__('Define styles for h2 heading', 'adorn'),
			'parent'		=> $panel_headings
		));

		$row_heading_h2_1 = adorn_edge_add_admin_row(array(
		...
		$row_heading_h2_2 = adorn_edge_add_admin_row(array(
        ...
        $row_heading_h2_3 = adorn_edge_add_admin_row(array(
        ...
        //H3
		$group_heading_h3 = adorn_edge_add_admin_group(array(
			'name'			=> 'group_heading_h3',
			'title'			=> esc_html__('H3 Style', 'adorn'),
			'description'	=> esc_html__('Define styles for h3 heading', 'adorn'),
			'parent'		=> $panel_headings
		));

		$row_heading_h3_1 = adorn_edge_add_admin_row(array(
		...
		$row_heading_h3_2 = adorn_edge_add_admin_row(array(
        ...
        $row_heading_h3_3 = adorn_edge_add_admin_row(array(
        ...
        //H4
		$group_heading_h4 = adorn_edge_add_admin_group(array(
			'name'			=> 'group_heading_h4',
			'title'			=> esc_html__('H4 Style', 'adorn'),
			'description'	=> esc_html__('Define styles for h4 heading', 'adorn'),
			'parent'		=> $panel_headings
		));

		$row_heading_h4_1 = adorn_edge_add_admin_row(array(
		...
		$row_heading_h4_2 = adorn_edge_add_admin_row(array(
        ...
        $row_heading_h4_3 = adorn_edge_add_admin_row(array(
        ...
        //H5
		$group_heading_h5 = adorn_edge_add_admin_group(array(
			'name'			=> 'group_heading_h5',
			'title'			=> esc_html__('H5 Style', 'adorn'),
			'description'	=> esc_html__('Define styles for h5 heading', 'adorn'),
			'parent'		=> $panel_headings
		));

		$row_heading_h5_1 = adorn_edge_add_admin_row(array(
		...
		$row_heading_h5_2 = adorn_edge_add_admin_row(array(
        ...
        $row_heading_h5_3 = adorn_edge_add_admin_row(array(
        ...
        //H6
		$group_heading_h6 = adorn_edge_add_admin_group(array(
			'name'			=> 'group_heading_h6',
			'title'			=> esc_html__('H6 Style', 'adorn'),
			'description'	=> esc_html__('Define styles for h6 heading', 'adorn'),
			'parent'		=> $panel_headings
		));

		$row_heading_h6_1 = adorn_edge_add_admin_row(array(
		...
		$row_heading_h6_2 = adorn_edge_add_admin_row(array(
        ...
        $row_heading_h6_3 = adorn_edge_add_admin_row(array(
		 ...
		 */
		$panel_responsive_headings3 = adorn_edge_add_admin_panel(
			array(
				'page' => '_fonts_page',
				'name' => 'panel_responsive_headings3',
				'title' => esc_html__('Headings Responsive (Tablet Landscape View)', 'adorn')
			)
		);

		//H1
		$group_responsive3_heading_h1 = adorn_edge_add_admin_group(array(
			'name'			=> 'group_responsive3_heading_h1',
			'title'			=> esc_html__('H1 Responsive Style', 'adorn'),
			'description'	=> esc_html__('Define responsive styles for h1 heading', 'adorn'),
			'parent'		=> $panel_responsive_headings3
		));

		$row_responsive_heading_h1_3 = adorn_edge_add_admin_row(array(
		...
		//H2
		$group_responsive3_heading_h2 = adorn_edge_add_admin_group(array(
			'name'			=> 'group_responsive3_heading_h2',
			'title'			=> esc_html__('H2 Responsive Style', 'adorn'),
			'description'	=> esc_html__('Define responsive styles for h2 heading', 'adorn'),
			'parent'		=> $panel_responsive_headings3
		));

		$row_responsive_heading_h2_3 = adorn_edge_add_admin_row(array(
		...
		//H3
		$group_responsive3_heading_h3 = adorn_edge_add_admin_group(array(
			'name'			=> 'group_responsive3_heading_h3',
			'title'			=> esc_html__('H3 Responsive Style', 'adorn'),
			'description'	=> esc_html__('Define responsive styles for h3 heading', 'adorn'),
			'parent'		=> $panel_responsive_headings3
		));

		$row_responsive_heading_h3_3 = adorn_edge_add_admin_row(array(
		...
		//H4
		$group_responsive3_heading_h4 = adorn_edge_add_admin_group(array(
			'name'			=> 'group_responsive3_heading_h4',
			'title'			=> esc_html__('H4 Responsive Style', 'adorn'),
			'description'	=> esc_html__('Define responsive styles for h4 heading', 'adorn'),
			'parent'		=> $panel_responsive_headings3
		));

		$row_responsive_heading_h4_3 = adorn_edge_add_admin_row(array(
		...
		//H5
		$group_responsive3_heading_h5 = adorn_edge_add_admin_group(array(
			'name'			=> 'group_responsive3_heading_h5',
			'title'			=> esc_html__('H5 Responsive Style', 'adorn'),
			'description'	=> esc_html__('Define responsive styles for h5 heading', 'adorn'),
			'parent'		=> $panel_responsive_headings3
		));

		$row_responsive_heading_h5_3 = adorn_edge_add_admin_row(array(
		...
		//H6
		$group_responsive3_heading_h6 = adorn_edge_add_admin_group(array(
			'name'			=> 'group_responsive3_heading_h6',
			'title'			=> esc_html__('H6 Responsive Style', 'adorn'),
			'description'	=> esc_html__('Define responsive styles for h6 heading', 'adorn'),
			'parent'		=> $panel_responsive_headings3
		));

		$row_responsive_heading_h6_3 = adorn_edge_add_admin_row(array(
		 ...
		 */
		$panel_responsive_headings = adorn_edge_add_admin_panel(
			array(
				'page' => '_fonts_page',
				'name' => 'panel_responsive_headings',
				'title' => esc_html__('Headings Responsive (Tablet Portrait View)', 'adorn')
			)
		);

		//H1
		$group_responsive_heading_h1 = adorn_edge_add_admin_group(array(
		...
		$row_responsive_heading_h1_1 = adorn_edge_add_admin_row(array(
		...
		//H2
		$group_responsive_heading_h2 = adorn_edge_add_admin_group(array(
		...
		$row_responsive_heading_h2_1 = adorn_edge_add_admin_row(array(
		...
		//H3
		$group_responsive_heading_h3 = adorn_edge_add_admin_group(array(
		...
		$row_responsive_heading_h3_1 = adorn_edge_add_admin_row(array(
		...
		//H4
		$group_responsive_heading_h4 = adorn_edge_add_admin_group(array(
		...
		$row_responsive_heading_h4_1 = adorn_edge_add_admin_row(array(
		...
		//H5
		$group_responsive_heading_h5 = adorn_edge_add_admin_group(array(
		...
		$row_responsive_heading_h5_1 = adorn_edge_add_admin_row(array(
		...
		//H6
		$group_responsive_heading_h6 = adorn_edge_add_admin_group(array(
		...
		$row_responsive_heading_h6_1 = adorn_edge_add_admin_row(array(
		 ...
		 */
		$panel_responsive_headings2 = adorn_edge_add_admin_panel(
			array(
				'page' => '_fonts_page',
				'name' => 'panel_responsive_headings2',
				'title' => esc_html__('Headings Responsive (Mobile Devices)', 'adorn')
			)
		);

		//H1
		$group_responsive2_heading_h1 = adorn_edge_add_admin_group(array(
		...
		$row_responsive2_heading_h1_1 = adorn_edge_add_admin_row(array(
		...
		//H2
		$group_responsive2_heading_h2 = adorn_edge_add_admin_group(array(
		...
		$row_responsive2_heading_h2_1 = adorn_edge_add_admin_row(array(
		...
		//H3
		$group_responsive2_heading_h3 = adorn_edge_add_admin_group(array(
		...
		$row_responsive2_heading_h3_1 = adorn_edge_add_admin_row(array(
		...
		//H4
		$group_responsive2_heading_h4 = adorn_edge_add_admin_group(array(
		...
		$row_responsive2_heading_h4_1 = adorn_edge_add_admin_row(array(
		...
		//H5
		$group_responsive2_heading_h5 = adorn_edge_add_admin_group(array(
		...
		$row_responsive2_heading_h5_1 = adorn_edge_add_admin_row(array(
		...
		//H6
		$group_responsive2_heading_h6 = adorn_edge_add_admin_group(array(
		...
		$row_responsive2_heading_h6_1 = adorn_edge_add_admin_row(array(
		 ...
		 * Text
		 */
		$panel_text = adorn_edge_add_admin_panel(
			array(
				'page' => '_fonts_page',
				'name' => 'panel_text',
		...
		$group_text = adorn_edge_add_admin_group(array(
			'name'			=> 'group_text',
			'title'			=> esc_html__('Paragraph', 'adorn'),
			'description'	=> esc_html__('Define styles for paragraph text', 'adorn'),
			'parent'		=> $panel_text
		));

		$row_text_1 = adorn_edge_add_admin_row(array(
			'name'		=> 'row_text_1',
			'parent'	=> $group_text
		));
		...
		$row_text_2 = adorn_edge_add_admin_row(array(
			'name'		=> 'row_text_2',
			'parent'	=> $group_text,
			'next'		=> true
		));
		...
		$group_text_res1 = adorn_edge_add_admin_group(array(
			'name'			=> 'group_text_res1',
			'title'			=> esc_html__('Paragraph Responsive (Table Portrait View)', 'adorn'),
			'description'	=> esc_html__('Define responsive styles for paragraph text for table devices - portrait view', 'adorn'),
			'parent'		=> $panel_text
		));

		$row_res_text_1 = adorn_edge_add_admin_row(array(
			'name'		=> 'row_text_1',
		...
		$group_text_res2 = adorn_edge_add_admin_group(array(
			'name'			=> 'group_text_res2',
			'title'			=> esc_html__('Paragraph Responsive (Mobile Devices)', 'adorn'),
			'description'	=> esc_html__('Define responsive styles for paragraph text for mobile devices', 'adorn'),
			'parent'		=> $panel_text
		));

		$row_res_text_2 = adorn_edge_add_admin_row(array(
			'name'		=> 'row_res_text_2',
		...
		$group_link = adorn_edge_add_admin_group(array(
			'name'			=> 'group_link',
			'title'			=> esc_html__('Links', 'adorn'),
			'description'	=> esc_html__('Define styles for link text', 'adorn'),
			'parent'		=> $panel_text
		));

		$row_link_1 = adorn_edge_add_admin_row(array(
			'name'		=> 'row_link_1',
			'parent'	=> $group_link
		));
		...
		adorn_edge_add_admin_field(array(
			...
			'name'			=> 'link_color',
			'default_value'	=> '',
			'label'			=> esc_html__('Link Color', 'adorn'),
			'parent'		=> $row_link_1
		));
		...
		adorn_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Hover Link Color', 'adorn'),
			'parent'		=> $row_link_1
		));

		$row_link_2 = adorn_edge_add_admin_row(array(
			'name'		=> 'row_link_2',
			'parent'	=> $group_link,
			'next'		=> true
		));
		...
		adorn_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Link Decoration', 'adorn'),
			'options'		=> adorn_edge_get_text_decorations(),
			'parent'		=> $row_link_2
		));
		...
		adorn_edge_add_admin_field(array(
			...
			'default_value'	=> '',
			'label'			=> esc_html__('Hovel Link Decoration', 'adorn'),
			'options'		=> adorn_edge_get_text_decorations(),
			'parent'		=> $row_link_2
		));
	}

	add_action( 'adorn_edge_options_map', 'adorn_edge_fonts_options_map', 3);
}