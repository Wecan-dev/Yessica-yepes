...
$row_content_width = $anchor = $content_text_aligment = $edge_row_wrapper_start = $edge_row_wrapper_end = '';
...
if (!empty($content_text_aligment)){
	$css_classes[] = 'edge-content-aligment-' . $content_text_aligment;
}
...
if($row_content_width === 'grid'){
	$edge_row_wrapper_start .= '<div class="edge-row-grid-section">';
	$edge_row_wrapper_end .= '</div>';
}
...
echo adorn_edge_get_module_part($output);