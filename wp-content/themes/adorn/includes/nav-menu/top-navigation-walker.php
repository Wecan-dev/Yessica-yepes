...
if (!class_exists('AdornEdgeTopNavigationWalker')) {
	class AdornEdgeTopNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				if($args->has_children && $depth == 0) {
					$item_output .= '<i aria-hidden="true" class="edge-menu-arrow arrow_carrot-down"></i>';
				}
