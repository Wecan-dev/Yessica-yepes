...
if (!class_exists('AdornEdgeMobileNavigationWalker')) {
	class AdornEdgeMobileNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				if($args->has_children) {
					$item_output .= '<span class="mobile_arrow"><i class="edge-sub-arrow edge-icon-font-elegant arrow_carrot-right"></i><i class="edge-icon-font-elegant arrow_triangle-down"></i></span>';
				}
			}
