...
if (!class_exists('AdornEdgeFullscreenNavigationWalker')) {
	class AdornEdgeFullscreenNavigationWalker extends Walker_Nav_Menu {
		...
		function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
			...
			if($item->hide == ""){
				...
				if($args->has_children) {
					$item_output .= '<i class="edge-fullscreen-menu-arrow edge-menu-arrow arrow_carrot-down"></i>';
				}
				$item_output .= '</a>';
			}
